        ...
        <div className="container flex flex-col  justify-center items-center mt-32 space-y-12">
          ...
          <div className="missions flex flex-col space-y-14">
            ...
            <div className="mission-top w-full flex space-x-16">
              <span
                className=" info1 w-[500px] h-[400px] text-2xl py-12 px-10 bg-[#d84040] text-white leading-loose"
                style={{ fontFamily: "'Saira Condensed', sans-serif" }}
              >
                Rakta is a project based for Health related sector. Due to high
                accidents and blood loss, blood is vital. Every individual could
                not buy blood bag due to high cost for them. Here our web
                application plays a vital role in connecting donors and
                acceptors.
              </span>
